...
//whx, trace flow compeletion time
        bind("max_short_flow_id", &max_short_flow_id); 
        bind("flow_id", &flow_id); 
        bind("start_time_whx", &start_time_whx); 
...
//whx, trace flow compeletion time
        ...
        delay_bind_init_one("start_time_whx");     
...
//whx, trace flow compeletion time
        ...
        if (delay_bind(varName, localName, "start_time", &start_time_whx, tracer)) return TCL_OK; 
